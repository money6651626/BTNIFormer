...
from model.basemodel.ChangeFormerBaseNetworks import *
...
class ChangeFormerV6_b1(nn.Module):

    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=64):
        super(ChangeFormerV6_b1, self).__init__()
        # Transformer Encoder
        self.embed_dims = [64, 128, 320, 512]
        self.depths = [2,2,2,2]
        self.embedding_dim = embed_dim
    ...
    def forward(self, x1, x2):
        ...
        # exit()
        return cp[-1]
class ChangeFormerV6_b2(nn.Module):

    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=64):
        super(ChangeFormerV6_b2, self).__init__()
        # Transformer Encoder
        self.embed_dims = [64, 128, 320, 512]
        self.depths = [3,3,6,3]
        self.embedding_dim = embed_dim
