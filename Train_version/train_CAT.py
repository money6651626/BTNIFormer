...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--log_message", default="Bit_base_CDD")
    parser.add_argument("--dataset_name", default="CDD")
    parser.add_argument('--net_G', default="base_transformer_pos_s4_dd8_dedim8", help='initial learning rate for adam')
    ...
    parser.add_argument("--resume", default=r"", type=str, help="path of checkpoint precede over start_epoch")
    ...
    parser.add_argument("--output_dir", default=r"E:\实验\weights\BIT_CDDD/")
