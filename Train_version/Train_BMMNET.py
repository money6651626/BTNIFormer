...
from utils.train_model import train_one_epoch,train_one_epoch_STA
from utils.val_model import val_one_epoch,val_one_epoch_STA
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--dataset_name", default="DSIFN")
