...
if __name__ == '__main__':
    gt_dir = r'F:\Pycharm_program\lunwen\datasets\CD_use\WHU_CD\test\label'
    pred_dir = r'C:\Users\money\Desktop\论文材料\out_ontest\DTCDSCN\WHU_CD'
    dst_dir = r'C:\Users\money\Desktop\论文材料\out_ontest\DTCDSCN\VIS\WHU_CD'
    img_dir = [r'F:\Pycharm_program\lunwen\datasets\CD_use\WHU_CD\test\A',
               r'F:\Pycharm_program\lunwen\datasets\CD_use\WHU_CD\test\B']
    #file_name = '1325.png'

    batch_list=os.listdir(img_dir[0])
